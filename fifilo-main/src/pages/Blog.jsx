...
export default function Blog() {
    ...
    useEffect(() => {
        if (!publishedblogdata) {
            console.log("run from blog page")
    ...
    return (
        <>
            ...
            <Helmet>
                <title>{!blogloading && publishedblogdata?.seoSection.title}</title>
                <meta name="keywords" content={!blogloading && publishedblogdata?.seoSection.keywords} />
                <meta name="description" content={!blogloading && publishedblogdata?.seoSection.description} />
                {!blogloading && publishedblogdata?.seoSection.seoImg.filename && <meta property="og:image" content={`http://localhost:5000/images/${!blogloading && publishedblogdata?.seoSection.seoImg.filename}`} />}
            ...
            <div className="blogs__list rn__section__gapTop">
                <div className="container">
                    <div className="row justify-content-center">
                        {!blogloading && !error && blogdata?.map((value, index) => {
                            if (Number(index) === 0) {
                                return (
